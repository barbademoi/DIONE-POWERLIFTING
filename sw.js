...
self.addEventListener('fetch',e=>{
  ...
  // Outros domínios (ex.: CDN do Supabase): cache-first simples
  ...
  // Páginas (HTML): network-first -> sempre pega a versão nova quando online; cai pro cache offline
  ...
  // Assets estáticos (imagens, css, etc.): cache-first
